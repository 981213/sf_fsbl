...
#endif
void dwc_ddrphy_apb_wr(u32 reg, u32 val)
{
//	printf("dwc_ddrphy_apb_wr(32'h%x,16'h%x);\n",reg,val);
	arm_writel(val, (SIFLOWER_DDR_PHY_BASE + 4*reg));
}

int dwc_ddrphy_apb_rd(u32 reg)
{
//	printf("dwc_ddrphy_apb_rd(32'h%x);\n",reg);
	return arm_readl(SIFLOWER_DDR_PHY_BASE + 4*reg);
}
...
int dwc_ddrphy_phyinit_setDefault(int Train2D)
{
        ...
        userInputBasic.NumActiveDbyteDfi1       = 0x0000;
        ...
        userInputAdvanced.ATxImpedance             = 60;      //with HardMacro family E, ATxImpedance will default to 40 Ohm instead
        ...
        userInputAdvanced.D4RxPreambleLength[0]    = 0x0001;   //freq ?
        ...
        uint8_t PhyVref              = 0x40; //input //Use Analytical VREF and Compensate for T28 Attenuator, see PHY databook
	...
	//input
        ...
        RTT_NOM_WR_PARK0[0] = 0x1 | (rtt_park << 6) | (rtt_wr << 9) | (rtt_nom << 3);
        //   ODIC = 0x1;
        ...
        for (myps=0; myps<1; myps++) {
                ...
                //input
                mb_DDR4U_1D[myps].SequenceCtrl         = SequenceCtrl[myps];
                mb_DDR4U_1D[myps].PhyConfigOverride    = 0x0;
                //input
                mb_DDR4U_1D[myps].HdtCtrl              = HdtCtrl;
                mb_DDR4U_1D[myps].MsgMisc              = MsgMisc;
                mb_DDR4U_1D[myps].Reserved00           = Reserved00;
                mb_DDR4U_1D[myps].DFIMRLMargin         = DFIMRLMargin;
                mb_DDR4U_1D[myps].PhyVref              = PhyVref;
                mb_DDR4U_1D[myps].DramType             = 0x2;
                ...
                mb_DDR4U_1D[myps].EnabledDQs           = (userInputBasic.NumActiveDbyteDfi0+userInputBasic.NumActiveDbyteDfi1)*8;
                mb_DDR4U_1D[myps].PhyCfg               = (mr3[myps]&0x8) ? 0 : userInputAdvanced.Is2Ttiming[myps];
                mb_DDR4U_1D[myps].X16Present           = (0x10==userInputBasic.DramDataWidth) ? mb_DDR4U_1D[myps].CsPresent : 0x0;
                ...
                mb_DDR4U_1D[myps].MR0                  = mr0[myps];
                mb_DDR4U_1D[myps].MR1                  = mr1[myps];
                mb_DDR4U_1D[myps].MR2                  = mr2[myps];
                mb_DDR4U_1D[myps].MR3                  = mr3[myps];
                mb_DDR4U_1D[myps].MR4                  = mr4[myps];
                mb_DDR4U_1D[myps].MR5                  = mr5[myps];
                mb_DDR4U_1D[myps].MR6                  = mr6[myps];

                mb_DDR4U_1D[myps].ALT_CAS_L            = ALT_CAS_L[myps];
                mb_DDR4U_1D[myps].ALT_WCAS_L           = ALT_WCAS_L[myps];

                mb_DDR4U_1D[myps].VrefDqR0Nib0      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib1      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib2      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib3      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib4      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib5      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib6      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib7      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib8      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib9      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib10      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib11      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib12      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib13      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib14      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib15      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib16      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib17      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib18      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR0Nib19      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib0      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib1      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib2      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib3      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib4      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib5      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib6      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib7      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib8      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib9      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib10      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib11      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib12      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib13      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib14      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib15      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib16      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib17      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib18      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR1Nib19      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib0      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib1      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib2      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib3      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib4      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib5      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib6      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib7      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib8      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib9      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib10      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib11      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib12      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib13      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib14      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib15      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib16      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib17      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib18      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR2Nib19      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib0      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib1      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib2      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib3      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib4      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib5      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib6      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib7      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib8      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib9      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib10      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib11      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib12      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib13      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib14      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib15      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib16      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib17      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib18      = 0x0000; //Outputs - just initialize these to zero
                mb_DDR4U_1D[myps].VrefDqR3Nib19      = 0x0000; //Outputs - just initialize these to zero
