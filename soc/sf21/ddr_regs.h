...
#define SIFLOWER_DDR_PHY_BASE			0x0A000000
#define SIFLOWER_DDR_CTL_BASE			0x0d000000
...
#define DDR_UMCTL2_MSTR2             	(SIFLOWER_DDR_CTL_BASE+0x028)		//DDR_UMCTL2_MRCTRL2
...
#define DDR_UMCTL2_INIT6                 	(SIFLOWER_DDR_CTL_BASE+0x0E8)		//SDRAM Initialization Register 6, LPDDR2/DDR3
#define DDR_UMCTL2_INIT7                 	(SIFLOWER_DDR_CTL_BASE+0x0EC)		//SDRAM Initialization Register 7, LPDDR2/DDR3
...
#define DDR_UMCTL2_DRAMTMG9              	(SIFLOWER_DDR_CTL_BASE+0x124)		//SDRAM Timing Register 9
#define DDR_UMCTL2_DRAMTMG10              	(SIFLOWER_DDR_CTL_BASE+0x128)		//SDRAM Timing Register 10
#define DDR_UMCTL2_DRAMTMG11             	(SIFLOWER_DDR_CTL_BASE+0x12C)		//SDRAM Timing Register 11
#define DDR_UMCTL2_DRAMTMG12              	(SIFLOWER_DDR_CTL_BASE+0x130)		//SDRAM Timing Register 12
#define DDR_UMCTL2_DRAMTMG13              	(SIFLOWER_DDR_CTL_BASE+0x134)		//SDRAM Timing Register 13
#define DDR_UMCTL2_DRAMTMG14              	(SIFLOWER_DDR_CTL_BASE+0x138)		//SDRAM Timing Register 14
#define DDR_UMCTL2_DRAMTMG15              	(SIFLOWER_DDR_CTL_BASE+0x13C)		//SDRAM Timing Register 15
...
#define DDR_UMCTL2_DFISTAT					(SIFLOWER_DDR_CTL_BASE+0x1BC)
#define DDR_UMCTL2_DBICTL					(SIFLOWER_DDR_CTL_BASE+0x1C0)		//DM/DBI Control Register
#define DDR_UMCTL2_DFIPHYMSTR					(SIFLOWER_DDR_CTL_BASE+0x1C4)		//DFI PHY Master
...
#define DDR_UMCTL2_DQMAP0					(SIFLOWER_DDR_CTL_BASE+0x280)		//DQ Map Register 0
#define DDR_UMCTL2_DQMAP1					(SIFLOWER_DDR_CTL_BASE+0x284)		//DQ Map Register 1
#define DDR_UMCTL2_DQMAP2					(SIFLOWER_DDR_CTL_BASE+0x288)		//DQ Map Register 2
#define DDR_UMCTL2_DQMAP3					(SIFLOWER_DDR_CTL_BASE+0x28c)		//DQ Map Register 3
#define DDR_UMCTL2_DQMAP4					(SIFLOWER_DDR_CTL_BASE+0x290)		//DQ Map Register 4
#define DDR_UMCTL2_DQMAP5					(SIFLOWER_DDR_CTL_BASE+0x294)		//DQ Map Register 5
...
#define DDR_UMCTL2_SWCTLSTATIC					(SIFLOWER_DDR_CTL_BASE+0x328)		//static registers write enable
...
#define DDR_UMCTL2_PCFGR_4					(SIFLOWER_DDR_CTL_BASE+0x6c4)		//Port 4 Configuration Read Register
#define DDR_UMCTL2_PCFGW_4					(SIFLOWER_DDR_CTL_BASE+0x6c8)		//Port 4 Configuration Write Register
#define DDR_UMCTL2_PCTRL_4					(SIFLOWER_DDR_CTL_BASE+0x750)           //Port 4 Control Register
#define DDR_UMCTL2_PCFGQOS0_4               (SIFLOWER_DDR_CTL_BASE+0x754)		//Port 4 Read QoS Configuration Register 0
#define DDR_UMCTL2_PCFGQOS1_4               (SIFLOWER_DDR_CTL_BASE+0x758)		//Port 4 Read QoS Configuration Register 1
#define DDR_UMCTL2_PCFGWQOS0_4              (SIFLOWER_DDR_CTL_BASE+0x75c)		//Port 4 Write QoS Configuration Register 0
#define DDR_UMCTL2_PCFGWQOS1_4              (SIFLOWER_DDR_CTL_BASE+0x760)		//Port 4 Write QoS Configuration Register 1
